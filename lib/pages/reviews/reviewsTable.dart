        ...
        children: [
          ...
          FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (BuildContext context, snapshot) {
              if (snapshot.hasData) {
                var status = <Restaurent>[];
                var data = snapshot.data!.docs;

                for (var element in data) {
                  status.add(Restaurent.fromMap(element.data()));
                }
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(child: Text(status[index].name)),
                                    Expanded(child: Text(status[index].email)),
                                    Expanded(child: Text(status[index].phone)),
                                    Expanded(
                                        child: Text(status[index].address)),
                                    SizedBox(
                                      height: 50,
                                      width: 150,
